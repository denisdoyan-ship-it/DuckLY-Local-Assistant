...
## О проекте
Это **open-source** проект на русском языке, полностью разработанный на **чистом Python**. Моя цель заключалась в создании его **без использования сторонних библиотек** — и я с гордостью могу сказать, что у меня это получилось! 

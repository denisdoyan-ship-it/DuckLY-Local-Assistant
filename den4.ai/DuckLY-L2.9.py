...
class ChatApplication:
    ...
    def __init__(self, root):
        ...
        system_message = {
            ...
            - Вызов инструмента за инструментом (в разных сообщениях), если требуется
        ...
        if state:
            ...
            for msg in restored_messages:
                if msg["role"] != "system":
                    self.display_message(codecs.decode(msg["content"].replace("\\", '"'), "unicode_escape"), "user" if msg["role"] == "user" else "assistant")

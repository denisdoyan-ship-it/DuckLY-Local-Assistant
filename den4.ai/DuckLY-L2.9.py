...
class ChatApplication:
    ...
    def ask_for_approval(self, call_line):
        ...
        approve_btn = Button(
            ...
            pady=6,
            cursor="hand2",
            command=lambda: self.execute_pending_action(True)
        )
        ...
        deny_btn = Button(
            ...
            pady=6,
            cursor="hand2",
            command=lambda: self.execute_pending_action(False)
        )
        deny_btn.pack(side=tk.LEFT)

        self._scroll_to_bottom()
    
    def execute_pending_action(self, approved):
        global pending_action
    ...
    def speak_text(self, text):
        ...
        try:
            ...
            print(f"[TTS Error] Ошибка озвучки: {e}")
